...
describe('Internationalized date and time components', () => {
  ...
  it('FormattedDate renders ISO8601 formatted date-time string in en-gb locale', () => {
    const wrapper = render((<IntlProvider locale="en-gb"><FormattedDate value={dateTimeString} /></IntlProvider>));
  ...
  it('FormattedTime renders ISO8601 formatted date-time string  in en-gb locale', () => {
    const wrapper = render((<IntlProvider locale="en-gb"><FormattedTime value={dateTimeString} /></IntlProvider>));
  ...
  it('FormattedDate renders date ISO8601 formatted date-time string in en-us locale', () => {
    const wrapper = render((<IntlProvider locale="en-us"><FormattedDate value={dateTimeString} /></IntlProvider>));
  ...
  it('FormattedTime renders ISO8601 formatted date-time string  in en-us locale', () => {
    const wrapper = render((<IntlProvider locale="en-us"><FormattedTime value={dateTimeString} /></IntlProvider>));
