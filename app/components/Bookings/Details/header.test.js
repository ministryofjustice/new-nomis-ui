...
describe('Header component', () => {
  it('should render correctly', () => {
    const wrapper = shallow(<Header inmateData={inmate(allAlerts)} onImageClick={jest.fn()} offenderNo={'A1234RT'} />);
  ...
  it('should ignore irrelevant alert flags', () => {
    const wrapper = shallow(<Header inmateData={inmate(irrelevantAlerts)} onImageClick={jest.fn()} offenderNo={'A1234RE'} />);

    expect(wrapper.find('div.align-alerts span')).toHaveLength(0);
  });

  it('should render MiddleSection correctly large', () => {
    const wrapper = shallow(<Header inmateData={inmate(allAlerts)} onImageClick={jest.fn()} offenderNo={'A1234RE'} />);
  ...
  it('should render MiddleSection correctly small', () => {
    const wrapper = shallow(<Header inmateData={inmate(allAlerts)} onImageClick={jest.fn()} offenderNo={'A1234RN'} />);
