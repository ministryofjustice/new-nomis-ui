...
class InformationPageMobile extends PureComponent { // eslint-disable-line react/prefer-stateless-function
  render() {
    const { modalData } = this.props;
    return (
      <ModalMobileComponent modalData={modalData} />
    );
  }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(InformationPageMobile);
