...
const selectData = () => createSelector(selectConfig(), configState => configState.get('data'))

const selectApi = () => createSelector(selectData(), configState => configState.get('apiServer'))

// Transform search data into more useable list.
const selectBookingsSearch = () =>
  createSelector(selectData(), configState =>
    configState
